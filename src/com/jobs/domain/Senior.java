...
public class Senior extends Employee{
	...
	public Senior(String name, String address, String phone, double grossSalaryPerMonth, IPaymentRate paymentRate) throws Exception {
		...
		if(netSalaryPerMonth<2700 || netSalaryPerMonth>4000) throw new SueldoSeniorException();
	...
	public String toString() {
		return "Senior [id=" + id + ", name=" + name + ", address=" + address + ", phone=" + phone + ", netSalaryPerMonth=" + netSalaryPerMonth 
