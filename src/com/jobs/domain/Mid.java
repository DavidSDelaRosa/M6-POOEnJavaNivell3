...
public class Mid extends Employee{
	...
	public Mid(String name, String address, String phone, double grossSalaryPerMonth, IPaymentRate paymentRate) throws Exception {
		...
		if(netSalaryPerMonth<1800 || netSalaryPerMonth>2500) throw new SueldoMidException();
	...
	public String toString() {
		return "Mid [id=" + id + ", name=" + name + ", address=" + address + ", phone=" + phone + ", netSalaryPerMonth=" + netSalaryPerMonth 
