...
public class Junior extends Employee{
	...
	public Junior(String name, String address, String phone, double grossSalaryPerMonth, IPaymentRate paymentRate) throws Exception {
		...
		if(netSalaryPerMonth<900 || netSalaryPerMonth>1600) throw new SueldoJuniorException();
	...
	public String toString() {
		return "Junior [id=" + id + ", name=" + name + ", address=" + address + ", phone=" + phone + ", netSalaryPerMonth=" + netSalaryPerMonth 
