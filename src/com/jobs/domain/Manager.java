...
public class Manager extends Employee{
	...
	public Manager(String name, String address, String phone, double grossSalaryPerMonth, IPaymentRate paymentRate) throws Exception {
		...
		if(netSalaryPerMonth<3000 || netSalaryPerMonth>5000) throw new SueldoManagerException();
	...
	public String toString() {
		return "Manager [id=" + id + ", name=" + name + ", address=" + address + ", phone=" + phone + ", netSalaryPerMonth=" + netSalaryPerMonth 
	...
	public void applyBonus() {
		netSalaryPerMonth += (netSalaryPerYear*0.1); 
