...
public abstract class Employee extends AbsStaffMember {
	...
	public String toString() {
		return "Employee [id="
				+ id + ", name=" + name + ", address=" + address + ", phone=" + phone + ", totalPaid=" + totalPaid
				+ ", netSalaryPerMonth=" + netSalaryPerMonth + ", netSalaryPerYear=" + netSalaryPerYear +  "]";
	}
